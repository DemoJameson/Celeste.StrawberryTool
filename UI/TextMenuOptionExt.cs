    ...
    public class TextMenuOptionExt<T> : TextMenu.Option<T> {
        ...
        public override void Render(Vector2 position, bool highlighted) {
            ...
            Color color = Disabled
                ? Color.DarkSlateGray
                : (highlighted ? Container.HighlightColor : getUnselectedColor()) * alpha;
            ...
            if (Values.Count > 0) {
                ...
                ActiveFont.DrawOutline(Values[Index].Item1,
                    position + new Vector2(Container.Width - num * 0.5f + lastDir * ValueWiggler.Value * 8f, 0f),
                ...
                Vector2 position2 =
                    position + new Vector2(Container.Width - num + 40f + (lastDir < 0 ? -ValueWiggler.Value * 8f : 0f),
                        0f) - (flag ? vector : Vector2.Zero);
                ...
                Vector2 position3 =
                    position + new Vector2(Container.Width - 40f + (lastDir > 0 ? ValueWiggler.Value * 8f : 0f), 0f) +
                    (flag2 ? vector : Vector2.Zero);
