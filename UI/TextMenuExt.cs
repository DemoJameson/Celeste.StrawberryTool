...
namespace Celeste.Mod.StrawberryTool.UI {
    /// <summary>
    ///     This class recreates some of the options in vanilla Celeste, making them extend TextMenuOptionExt instead of
    ///     TextMenu.Option.
    /// </summary>
    public class TextMenuExt {
        public class Slider : TextMenuOptionExt<int> {
            public Slider(string label, Func<int, string> values, int min, int max, int value, int defaultIndex) : base(
                label, defaultIndex) {
